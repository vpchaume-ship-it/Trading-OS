...
python -m trading_os.data.deep 12 2>/dev/null || echo "extension historique profond KO — on continue"
...
git add data/yahoo_*.csv data/deep_*.csv.gz data/strategy_state.json journal/news/history.csv journal/trades.csv 2>/dev/null || true
