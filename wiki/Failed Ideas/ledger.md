...
| 2026-07 | SMT (divergence ES/NQ sur niveaux de session) comme filtre BLOQUANT | 4 054 setups rejetés → 4-11 trades/24 mois, invalidable statistiquement ; ES/NQ trop corrélés pour que la divergence stricte soit fréquente | abandonnée (code conservé, `require_smt`) |
| 2026-07 | Sélection quotidienne de variante par l'autotune | Bruit pur à cadence sniper (WF change de signe selon le calibrage des plis) | remplacée par le pré-enregistrement |
